...
<Link to="https://drive.google.com/file/d/1r9p-fDPYnw0yt2Up5VSyHCqexM85JJ5J/view?usp=sharing"><motion.li whileHover={{scale:1.1}} whileTap={{scale:0.9}} animate={{duration:1,delay:0}}class="list-group-item mt-3"> <i class="fa-solid fa-link fa-lg"></i>   Resume</motion.li></Link>
